            ...
            <Carousel
                ...
                renderArrowPrev={(clickHandler, hasPrev) => (
                    <div
                        ...
                        className="absolute right-[31px] md:right-[55px] bottom-0 w-[30px] md:w-[50px] h-[30px] md:h-[50px] bg-black z-10 flex items-center justify-center cursor-pointer hover:opacity-90"
                    >
